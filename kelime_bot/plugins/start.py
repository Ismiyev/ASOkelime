...
keyboard = InlineKeyboardMarkup([
    [
        InlineKeyboardButton("➕ Məni Grupa Əlavə Et ➕️", url=f"http://t.me/ASOsozutap_bot?startgroup=new")
    ],
    [
